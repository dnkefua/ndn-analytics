...
const STATIC_PRODUCTS: StaticProduct[] = [
  // ─── LLM APIs ─────────────────────────────────────────────────────────────
  {
    ...
    affiliateUrl: 'https://www.anthropic.com/claude?utm_source=ndnanalytics&utm_medium=referral&utm_campaign=aitools',
    affiliateProgram: 'none',
    commissionRate: 'No affiliate program',
    cookieDuration: 0,
    ndnServiceTieIn:
  ...
  },
  {
    ...
    affiliateUrl: 'https://platform.openai.com/signup?utm_source=ndnanalytics&utm_medium=referral&utm_campaign=aitools',
    affiliateProgram: 'none',
    commissionRate: 'No affiliate program',
    cookieDuration: 0,
    ndnServiceTieIn:
  ...
  // ─── Cloud Infrastructure ─────────────────────────────────────────────────
  {
    id: 'google-cloud',
    name: 'Google Cloud',
    tagline: 'The cloud built for AI — from data to deployment',
    description:
      'Google Cloud provides Vertex AI, BigQuery, Cloud Run, and 200+ services for building, training, and deploying AI at enterprise scale. The same infrastructure powering Google Search and DeepMind — now available to your team.',
    logoUrl: 'https://www.gstatic.com/devrel-devsite/prod/v0d7c1c6/cloud/images/favicons/onecloud/favicon.ico',
    websiteUrl: 'https://cloud.google.com',
    affiliateUrl: buildAffiliateUrl('https://cloud.google.com', 'gcp', 'aitools'),
    affiliateProgramUrl: 'https://cloud.google.com/affiliate-program',
    affiliateProgram: 'gcp',
    commissionRate: 'Tiered — scales with referrals',
    cookieDuration: 90,
    ndnServiceTieIn:
      'NDN Analytics deploys AI workloads on Google Cloud — Vertex AI pipelines, BigQuery analytics, and Cloud Run inference endpoints. Let us architect your GCP infrastructure.',
    category: 'infrastructure',
    tags: ['cloud', 'ai', 'bigquery', 'vertex-ai', 'enterprise', 'gcp'],
    pricing: 'paid',
    featured: true,
    sortOrder: 69,
    badge: 'CJ Affiliate',
