    ...
    <>
      ...
      <article style={{ paddingTop: 120, paddingBottom: 80, minHeight: '100vh' }}>
        <div className="container" style={{ maxWidth: 760 }}>
          <Link to="/blog" style={{ display: 'inline-block', marginBottom: 32, color: 'var(--brand-cyan)', textDecoration: 'none', fontFamily: "'JetBrains Mono Variable', monospace", fontSize: '0.8rem', letterSpacing: '0.05em' }}>← Back to Blog</Link>
          <div style={{ display: 'flex', gap: 8, marginBottom: 20, flexWrap: 'wrap' }}>
            <span style={{ fontSize: '0.7rem', fontFamily: "'JetBrains Mono Variable', monospace", color: 'var(--brand-cyan)', background: 'rgba(6,182,212,0.1)', padding: '4px 10px', borderRadius: 20, letterSpacing: '0.05em', textTransform: 'uppercase' }}>{post.category}</span>
          ...
          <div style={{ marginTop: 60, paddingTop: 32, borderTop: '1px solid var(--border-subtle)', textAlign: 'center' }}>
            <h3 style={{ fontFamily: "'Syne Variable', sans-serif", fontSize: '1.3rem', marginBottom: 12, color: 'var(--text-primary)' }}>Ready to learn more?</h3>
            <p style={{ color: 'var(--text-secondary)', marginBottom: 24 }}>Book a demo and see how NDN Analytics can transform your operations.</p>
